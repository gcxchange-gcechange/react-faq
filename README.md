...
- Added the ability to navigate through the FAQ using a keyboard.
- Added french text to the list.
- The FAQ will now work with a different sharepoint list (see below).
## Summary
