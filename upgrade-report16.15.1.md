# Upgrade project react-faq to v1.17.4
...
File: [src\webparts\reactFaq\components\ReactFaq.module.scss](src\webparts\reactFaq\components\ReactFaq.module.scss)
...
```json
{
  "solution": {
    "metadata": {
      "shortDescription": {
        "default": "spfxwebparts description"
      },
      "longDescription": {
        "default": "spfxwebparts description"
      },
...
```json
{
  "solution": {
    "features": [
      {
        "title": "spfxwebparts ReactFaqWebPart Feature",
        "description": "The feature that activates ReactFaqWebPart from the spfxwebparts solution.",
        "id": "a3c5e704-6f57-4f19-86ea-3a462c18780e",
        "version": "1.0.1.4",
        "componentIds": [
          "a3c5e704-6f57-4f19-86ea-3a462c18780e"
        ]
      }
    ]
  }
...
#### [src\webparts\reactFaq\components\ReactFaq.module.scss](src\webparts\reactFaq\components\ReactFaq.module.scss)
